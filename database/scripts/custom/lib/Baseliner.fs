...
// 3. restart adapter ImpModello
// 4. build structure under Generational Models, staging required to get the correct classes
// 5. align service models/production structure to generational models, baseline+alarmed elements structure
...
var Baseliner = (function () {
    ...
    var setEnv4MapppingStructure = function () {
        ...
        var prodRoot = formula.Root.findElement('Ambiente=Produzione/gen_folder=Servizi/gen_folder=Structure/root=Generational+Models/root=Services');
        prodRoot.walk(prodVisitor);
        var prodsystestVisitor = buildEnvSetterVisitor('Produzione/SystemTest');
        var prodsystestRoot = formula.Root.findElement('Ambiente=Produzione%2FSystemTest/gen_folder=Servizi/gen_folder=Structure/root=Generational+Models/root=Services');
    ...
    var _buildProduction = function () {
        ...
        state.ViewBuilder.build('gen_folder=Acronimi/gen_folder=Baseline%2BAlarmedElement/gen_folder=Structure/root=Generational+Models/root=Services');
        _logger.info('Env:Production, building view Baseline+Alarmed Elements/Servizi');
        state.ViewBuilder.build('gen_folder=Servizi/gen_folder=Baseline%2BAlarmedElement/gen_folder=Structure/root=Generational+Models/root=Services');
        ...
        state.ViewBuilder.build('gen_folder=Servizi/ISP_FolderBase=Production/root=Organizations');
    }
    ...
    var _buildSysTest = function () {
        ...
        state.ViewBuilder.build('gen_folder=Acronimi/gen_folder=Baseline%2BAlarmedElement_SystemTest/gen_folder=Structure/root=Generational+Models/root=Services');
        _logger.info('Env:SystemTest, building view Baseline+Alarmed Elements/Servizi');
        state.ViewBuilder.build('gen_folder=Servizi/gen_folder=Baseline%2BAlarmedElement_SystemTest/gen_folder=Structure/root=Generational+Models/root=Services');
    ...
    var _buildSdbxSysTest = function (buildGenModFlg) {
		buildGenModFlg = buildGenModFlg || true;
		if (buildGenModFlg) {
			// Baseline+AlarmedElement_SystemTest
			_logger.info('Env:SandboxSystemTest, building view Generational Models/Structure/Modello/SystemTest/Baseline/Acronimi');
			state.ViewBuilder.build('gen_folder=Acronimi/gen_folder=Baseline/gen_folder=SystemTest/gen_folder=Modello/gen_folder=Structure/root=Generational+Models/root=Service');
		} else {
			_logger.info('Env:SandboxSystemTest, skipping refresh under Generational Models');
		}
        ...
        state.ViewBuilder.build('gen_folder=Modello/ISP_FolderBase=SandboxSystemTest/root=Organizations');

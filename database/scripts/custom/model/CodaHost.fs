...
var CodaHost = (function () {
    ...
    var _setCodaUnderAcronimoMatch = function(ele) {
        var clazz = ele.elementClassName + "";
        var eleCurrentMatch = ele.Matches;
            var eleCalcMatch = '[Pattern-LDAP]:(&(objectClass=Risorsa)(cn=*' + ele.name + '))/gen_folder=Acronimi/ISP_FolderBase=Production/root=Organizations';
	...
	return {
		setCodaUnderAcronimoMatch:_setCodaUnderAcronimoMatch
	}
})();

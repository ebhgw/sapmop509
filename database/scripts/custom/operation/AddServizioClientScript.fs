...
//
	...
	jLabel1.setText("Insert Servizio");
	...
	dialog = new javax.swing.JDialog( frame, 'Insert Servizio', true )
	...
	(
		new java.awt.event.ActionListener()
		{
			...
			{
				var newServizio = jTextField1.getText();
				callback.addServizio(newServizio)
				dialog.setVisible( false )
			}
		}
	)

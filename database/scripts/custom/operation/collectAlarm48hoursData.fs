...
(function () {
// Set logging
var _logger = Packages.org.apache.log4j.Logger.getLogger('fs.alarm48hoursdata');
...
var callback =
{
    ...
    {
		return DatiecmIf.readAlarms48hours()+'';
    }
}
...
session.invokeScript( 'Choose file',
                      clientScript,
                      [ formula.util.makeRemote( callback ), element.name, 'allarmi' ],

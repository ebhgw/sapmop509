...
try {
	...
	if (this.args &&  this.args!=null &&  this.args!=undefined
		...
		workerscriptname="MOSservicecatalogAcceptWorkFlow"
		...
		if (this.alarms && this.alarms[0]) {
			retval=AcceptWorkFlow(args, element.dname, this.alarms)
		} else {
			retval=AcceptWorkFlow(args, element.dname)
		}
...
// @internal MOSServiceCatalogAcceptWorkFlow.fs 28e00b4

...
CREATE DATABASE FORMULA 
  ...
  COLLATE USING 
    SYSTEM USER TABLESPACE MANAGED BY SYSTEM 
      USING ('E:\application\NOC00\NovellOperationsCenter\NOC/database/samples/db2/user') 
      EXTENTSIZE 32 
    CATALOG TABLESPACE MANAGED BY SYSTEM 
      USING ('E:\application\NOC00\NovellOperationsCenter\NOC/database/samples/db2/system') 
      EXTENTSIZE 8 
    TEMPORARY TABLESPACE MANAGED BY SYSTEM 
      USING ('E:\application\NOC00\NovellOperationsCenter\NOC/database/samples/db2/temp') 
      EXTENTSIZE 32 
;
...
CREATE TABLESPACE BSAWAREHOUSE 
  ...
  USING (FILE 'E:\application\NOC00\NovellOperationsCenter\NOC/database/samples/db2/BSAwarehouse' 6400)
  EXTENTSIZE 32
  PREFETCHSIZE 16
...
CREATE TABLESPACE BSAWAREHOUSE_IDX
  IN NODEGROUP IBMDEFAULTGROUP 
  PAGESIZE 32768 MANAGED BY DATABASE 
  USING (FILE 'E:\application\NOC00\NovellOperationsCenter\NOC/database/samples/db2/BSAwarehouse_idx' 6400)
  EXTENTSIZE 32
  PREFETCHSIZE 16
  BUFFERPOOL FORMULAPOOL;
